...
--
-- Estrutura para tabela `entregas_atividades`
--
...
--
-- Estrutura para tabela `inscricoes_cursos`
--
...
--
-- Estrutura para tabela `materiais_atividades`
--
...
--
-- Despejando dados para a tabela `materiais_atividades`
--
...
--
-- Índices de tabela `entregas_atividades`
--
...
--
-- Índices de tabela `inscricoes_cursos`
--
...
--
-- Índices de tabela `materiais_atividades`
--
...
--
-- AUTO_INCREMENT de tabela `entregas_atividades`
--
ALTER TABLE `entregas_atividades`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `inscricoes_cursos`
--
ALTER TABLE `inscricoes_cursos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `materiais_atividades`
--
ALTER TABLE `materiais_atividades`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Restrições para tabelas `entregas_atividades`
--
ALTER TABLE `entregas_atividades`
...
--
-- Restrições para tabelas `inscricoes_cursos`
--
ALTER TABLE `inscricoes_cursos`
...
--
-- Restrições para tabelas `materiais_atividades`
--
ALTER TABLE `materiais_atividades`
